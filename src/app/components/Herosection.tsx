  ...
  return (
    <div className="relative mx-auto flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        ...
        <div className="flex flex-col justify-center mt-8 mb-4 items-center px-4">
        ...
        >
          ...
          <button
            ...
            onClick={() => window.open("https://github.com/VA5UDEV/clerk-startup-temp", "_blank")}
          >
            Github Repo
          </button>
        </motion.div>
  ...
  return (
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 px-4 py-4 dark:border-neutral-800">
      <div className="flex items-center gap-2">
        <div className="size-7 rounded-full bg-gradient-to-br from-blue-500 to-green-500" />
        <h1 className="text-base font-bold md:text-2xl">NextClerk</h1>
      </div>
      <SignedOut>
        <div className="w-24 transform rounded-lg bg-black px-6 py-2 font-medium text-white text-center transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-800 md:w-32 dark:bg-white dark:text-black dark:hover:bg-gray-200">
